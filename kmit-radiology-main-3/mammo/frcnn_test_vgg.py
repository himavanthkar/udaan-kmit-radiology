...
#from tensorflow.keras import initializers, regularizer

from .fileing import Config
...
config_output_filename =  os.path.join(os.getcwd(),'mammo/model_vgg_config.pickle')
...
def predictt(img,img_name):
    ...
    gt_data= pd.read_csv(os.getcwd()+'mammo/annotations.txt',sep=",",header=None)
